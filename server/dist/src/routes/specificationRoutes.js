...
const specificationController = __importStar(require("../controllers/specificationController"));
const router = express_1.default.Router();
// Get all specifications
router.get("/", specificationController.getAllSpecifications);
// Get specification by actif ID
router.get("/actif/:actifId", specificationController.getSpecificationByActifId);
