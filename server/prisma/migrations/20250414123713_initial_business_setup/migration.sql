...
-- CreateTable
CREATE TABLE "FournisseurContact" (
    ...
    CONSTRAINT "FournisseurContact_pkey" PRIMARY KEY ("contactId")
);
...
-- AddForeignKey
ALTER TABLE "FournisseurContact" ADD CONSTRAINT "FournisseurContact_fournisseurId_fkey" FOREIGN KEY ("fournisseurId") REFERENCES "Fournisseur"("fournisseurId") ON DELETE RESTRICT ON UPDATE CASCADE;
