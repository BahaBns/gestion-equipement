/*
  ...
  - You are about to drop the `ActifFournisseur` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "ActifFournisseur" DROP CONSTRAINT "ActifFournisseur_actifId_fkey";

-- DropForeignKey
ALTER TABLE "ActifFournisseur" DROP CONSTRAINT "ActifFournisseur_fournisseurId_fkey";
