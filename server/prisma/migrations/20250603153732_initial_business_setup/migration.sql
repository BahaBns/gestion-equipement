...
-- CreateTable
CREATE TABLE "ActifFournisseur" (
    "actifFournisseurId" TEXT NOT NULL,
    "actifId" TEXT NOT NULL,
    "fournisseurId" TEXT NOT NULL,
    "quantity" INTEGER NOT NULL DEFAULT 1,
    "assignedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ActifFournisseur_pkey" PRIMARY KEY ("actifFournisseurId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ActifFournisseur_actifId_fournisseurId_key" ON "ActifFournisseur"("actifId", "fournisseurId");
...
-- AddForeignKey
ALTER TABLE "ActifFournisseur" ADD CONSTRAINT "ActifFournisseur_actifId_fkey" FOREIGN KEY ("actifId") REFERENCES "Actif"("actifId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ActifFournisseur" ADD CONSTRAINT "ActifFournisseur_fournisseurId_fkey" FOREIGN KEY ("fournisseurId") REFERENCES "Fournisseur"("fournisseurId") ON DELETE RESTRICT ON UPDATE CASCADE;
